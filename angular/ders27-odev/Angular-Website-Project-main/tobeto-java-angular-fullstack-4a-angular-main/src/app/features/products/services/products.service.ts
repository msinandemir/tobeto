...
export class ProductsService {
  ...
  updateProductById(productId:number, product:ProductListItem): Observable<ProductListItem>{
    return this.http.put<ProductListItem>(`${this.apiControllerUrl}/${productId}`,product)
  }
