...
public class LUIKPSPublicSoap
{
    ...
    public LUIKPSPublicSoap(){}

    public LUIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LUIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LUIExtendedSoapSerializationEnvelope envelope= new LUIExtendedSoapSerializationEnvelope(LUIExtendedSoapSerializationEnvelope.VER11);
