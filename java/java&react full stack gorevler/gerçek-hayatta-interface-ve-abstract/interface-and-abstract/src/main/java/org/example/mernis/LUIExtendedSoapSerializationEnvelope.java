...
class LUISoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class LUIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LUIDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new LUIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LUIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LUIDateTimeConverter dateTimeConverter = new LUIStandardDateTimeConverter();

    public LUIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LUIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LUIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LUIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LUIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LUIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
